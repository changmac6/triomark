// Derived from scripts/risk-samples.js to support demo data seeding and repeatable fixtures.
...
export { component, buildClientComponents, buildServerRaw, buildEvent };
